...
public class class1009
{
	...
	public static String entry1 = class100.entry0().entry0();
	...
	public static final Color entry0()
	{
		...
		} catch(Exception var1)
		{
			...
			return Color.decode(class100.entry0().entry1005());
		}
	}
	...
	public static final Font entry0(float var0, int var1) throws FontFormatException
	{
		try
		{
			...
			{
				case 1:
					entry0 = Font.createFont(0, class1009.class.getResourceAsStream(entry1 + class100.entry0().entry0(1))).deriveFont(var0);
					break;
				case 2:
					entry0 = Font.createFont(0, class1009.class.getResourceAsStream(entry1 + class100.entry0().entry0(2))).deriveFont(var0);
					break;
				case 3:
					entry0 = Font.createFont(0, class1009.class.getResourceAsStream(entry1 + class100.entry0().entry0(3))).deriveFont(var0);
					break;
				default:
