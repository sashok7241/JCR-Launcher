...
public class class100
{
	...
	public static final class1038 entry0()
	{
	...
	public static final void entry0(BufferedImage var0, int var1)
	{
		if(var0 == null && var1 == -1)
		{
			entry1000 = entry0(entry0().entry1000());
			entry1001 = entry0(entry0().entry10());
			entry1002 = entry0(entry0().entry100());
			entry1003 = entry0(entry0().entry1006());
			entry1004 = entry0(entry0().entry1001());
			entry1005 = entry0(entry0().entry1002());
			entry1006 = entry0(entry0().entry1004());
			entry1007 = entry0(entry0().entry1003());
			entry1008 = entry0(entry0().entry101());
			entry1009 = entry0(entry0().entry1013());
			entry101 = entry0(entry0().entry1007());
			entry1010 = entry0(entry0().entry1008());
			entry1011 = entry0(entry0().entry1009());
			entry1012 = entry0(entry0().entry1011());
			entry1013 = entry0(entry0().entry1012());
			entry1014 = entry0(entry0().entry1010());
		} else
		{
			switch(var1)
			{
	...
	public static final BufferedImage entry0(String var0)
	{
		try
		{
			BufferedImage var1 = ImageIO.read(class100.class.getResource(entry0().entry0() + var0));
	...
	public static final void entry1()
	{
		...
		if(entry100)
		{
			...
			class1035.entry0 = Color.decode(entry0().entry1005());
		} else
		{
